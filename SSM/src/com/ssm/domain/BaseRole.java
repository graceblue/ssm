...
public class BaseRole implements java.io.Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8120039572243631392L;
	 ...
	 * 角色注册时间
	 */
	private Date roleStartTime;// 角色注册时间（只有用户关联角色的时�?�可�?,表示某用户对该角色的使用时限�?

	/**
	 * 角色到期时间
	 */
	private Date roleEndTime;// 角色到期时间（只有用户关联角色的时�?�可�?,表示某用户对该角色的使用时限�?

	/**
	 * 角色拥有的菜单权限
	 */
	private List<BaseMenu> menuPermission;// 角色拥有的菜单权�?

	/**
	 * 角色拥有的元素权限
	 */
	private List elPermission;// 角色拥有的元素权�?//TODO
